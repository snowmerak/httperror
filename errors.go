...
func (e *HttpError) ToJSON(marshal func(any) ([]byte, error)) ([]byte, error) {
	...
	builder.WriteString(strconv.Quote(e.Type))
	builder.WriteString(",")
	builder.WriteString("\"title\":")
	builder.WriteString(strconv.Quote(e.Title))
	builder.WriteString(",")
	builder.WriteString("\"status\":")
	builder.WriteString(strconv.Itoa(e.Status))
	builder.WriteString(",")
	builder.WriteString("\"detail\":")
	builder.WriteString(strconv.Quote(e.Detail))
	builder.WriteString(",")
	builder.WriteString("\"instance\":")
	builder.WriteString(strconv.Quote(e.Instance))
